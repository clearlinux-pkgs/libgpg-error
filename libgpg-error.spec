...
Source0  : https://gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-1.51.tar.gz
Source1  : https://gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-1.51.tar.gz.sig
...
%setup -q -n libgpg-error-1.51
cd %{_builddir}/libgpg-error-1.51
pushd ..
cp -a libgpg-error-1.51 build32
popd
pushd ..
cp -a libgpg-error-1.51 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731431743
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgpg-error.so.0.38.0
...
/usr/lib32/libgpg-error.so.0.38.0
