...
Source0  : https://gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-1.48.tar.gz
Source1  : https://gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-1.48.tar.gz.sig
...
%prep
%setup -q -n libgpg-error-1.48
cd %{_builddir}/libgpg-error-1.48
pushd ..
cp -a libgpg-error-1.48 build32
popd
pushd ..
cp -a libgpg-error-1.48 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708702069
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgpg-error.so.0.35.0
/usr/lib64/libgpg-error.so.0
/usr/lib64/libgpg-error.so.0.35.0
