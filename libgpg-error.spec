...
Source0  : https://gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-1.55.tar.gz
Source1  : https://gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-1.55.tar.gz.sig
...
%setup -q -n libgpg-error-1.55
cd %{_builddir}/libgpg-error-1.55
pushd ..
cp -a libgpg-error-1.55 build32
popd
pushd ..
cp -a libgpg-error-1.55 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745515635
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgpg-error.so.0.39.3
...
/usr/lib32/libgpg-error.so.0.39.3
